...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('front_radar_config_file',
                          default_value='front_radar_IWR1843_dca_RadVel_10Hz.json', #front_radar_IWR1843_dca_RadVel_10Hz (Hermes)
...
def launch_setup(context, *args, **kwargs):
    ...
    bringup_group = GroupAction([
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments=[
                ('user_config_file', livox_config_file),('tf_prefix', tf_prefix)],
